...
namespace Asp_Mvc_2015_2016
{
    ...
    public class ApplicationUserManager : UserManager<Gebruiker>
    {
        public ApplicationUserManager(IUserStore<Gebruiker> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Gebruiker>(context.Get<FacturatieDBContext>()));
    ...
    public class ApplicationSignInManager : SignInManager<Gebruiker, string>
    {
